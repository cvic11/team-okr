...
const GUIDES={
  objective:{title:'Objective — 분기 도달점의 정의',body:'KPI가 아니라 도달 후 변화의 모습. 짧고 외울 수 있어야(memorable) 팀이 따릅니다.',no:['"매출 10% 증가" — 결과 수치는 KR 자리'],yes:['"CU 창업 희망자들이 한결같이 미래전략팀 AI 어시스턴트를 이야기한다"','"GS25 대비 매출 2배 — 압도적 업계 1위 달성"'],check:'영감(Inspiring) · 정성(Qualitative) · 시간 제한 · 외울 수 있음 · 권장 1~3개/분기'},
